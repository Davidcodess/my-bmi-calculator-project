...
<div className='health-container'>
    <div className='health-container-text'>
      ...
      <div className='health-header-container'>
        <h5 className='health-header'>Healthy eating</h5>
        <p className='health-explained'> Healthy eating promotes weight control, disease prevention, better digestion, immunity, mental clarity, and mood </p>
    ...
    <div className='health-container-text'>
        ...
        <div className='health-header-container'>
            <h5 className='health-header'>Regular exercise</h5>
            <p className='health-explained'> Exercise improves fitness, aids weight control, elevates mood, and reduces disease risk, fostering wellness and longevity.</p>
        </div>
    ...
    <div className='health-container-text'>
        ...
        <div className='health-header-container'>
            <h5 className='health-header'>
            Adequate sleep</h5>
            <p className='health-explained'>Sleep enhances mental clarity, emotional stability, and physical wellness, promoting overall restoration and rejuvenation.</p>
        </div>
    </div>
</div>
    );
